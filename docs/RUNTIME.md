...
Phase 4.2 phải phân biệt runtime readiness với WordPress health sau mỗi start/restart. Từ Phase 4.9, `provisioning.ready` chứng minh installation + WooCommerce/CoffeePOS activation baseline đã hoàn tất nhưng vẫn không thay application health sau mỗi runtime start. Kiểm WordPress self-request/background jobs từ 4.6, CoffeePOS machine-health từ 4.10 và tải POS từ 5.2 trước gate LAN/release trong [ROADMAP.md](ROADMAP.md).
